...
$result = pg_query($db, "SELECT ad,soyad,cinsiyet,boy,kilo,dogum_tarihi,test_rapor,ilac_adi,res_id,lt_id,hasta_id FROM hasta where hasta_id = '$_POST[hid]'and hasta_tip = 'A'");
if (!$result) {
  echo "Hata olustu.\n";
  exit;
}
